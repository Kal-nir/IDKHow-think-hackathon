...
import { idlFactory } from './vanilla_icp_davao.did.js';
export { idlFactory } from './vanilla_icp_davao.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.VANILLA_ICP_DAVAO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vanilla_icp_davao.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vanilla_icp_davao canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vanilla_icp_davao.did.js")._SERVICE>}
 */
export const vanilla_icp_davao = createActor(canisterId);
